shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    p("Which genes to label are chosen based on Euclidean distance, but can be biased towards the X or Y dimension. All other settings should be self explanatory.",
      "Editing any settings will cause the plot to be redrawn, label positions are random NESW, so redraw to avoid overlapping labels."),
