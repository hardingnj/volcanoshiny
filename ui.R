shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    p("Which genes to label are chosen based on Euclidean distance from the origin, but can be biased towards the X or Y dimension. All other settings should be self explanatory.",
    ...
    sliderInput("nlabels", "number of labels to print", min=0, max=200, value=40, step = 1),
    sliderInput("minalpha", "minimum colour alpha level", min=0.0, max=0.25, value=0.10, step = 0.01),
